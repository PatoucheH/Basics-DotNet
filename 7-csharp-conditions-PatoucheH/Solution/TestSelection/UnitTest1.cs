...
namespace TestSelection
{
    public class Tests
    {
        ...
        {
            Assert.That(Selection.Solution.SignOfNumber(10), Is.EqualTo("The number is positive."));
        }

        [Test]
        public void Test_SignOfNumber_Negative()
        {
            Assert.That(Selection.Solution.SignOfNumber(-5), Is.EqualTo("The number is negative."));
        }

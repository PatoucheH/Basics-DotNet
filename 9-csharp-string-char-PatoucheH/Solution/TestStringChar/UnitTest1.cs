...
namespace TestStringChar
{
    public class Tests
    {
        ...
        {
            string result = StringChar.Solution.IsPalindrome("Elu par cette crapule");
            Assert.That(result, Is.EqualTo("This is a palindrome."));
        }

        [Test]
        public void Test_FirstNonRepeatingCharacter()
        {
           char result = StringChar.Solution.FirstNonRepeatingCharacter("Stress");
